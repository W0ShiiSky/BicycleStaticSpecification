...
$(function () {
    ...
    // No need for loadModelPromise as the model is on the server

    Promise.all([startVideoStreamPromise]).then(function () {
        $("body").removeClass("loading");
        resizeCanvas();
        modelLoaded = true;
    });
    ...
    const capturePhoto = function () {
        ...
        // Convert canvas to blob and send to the local server
